...
def main():
    ...
    parser.add_argument("--log_dir",default="../../logs_inference_ensemble_pipelined/",help="Log Directory Path")
    parser.add_argument("--model_dir",default="../../models_ensemble_300/",help="Model Directory Path")
    ...
    fashion_generator.pipelined_inference(batch_size,n_samples,levels,writer)
