...
from models.diffusion_vanilla import DiffusionModel
device = None
...
def main():
    ...
    parser.add_argument("--batch_size",default=16,help="Size of Batch")
    ...
    parser.add_argument("--log_dir",default="../../logs_inference_vanilla/",help="Log Directory Path")
    parser.add_argument("--model_dir",default="../../models_vanilla_300/",help="Model Directory Path")
    parser.add_argument("--levels", default=1, type=int, help='Represents the number of levels')
    parser.add_argument("--n_samples", default=1024, type=int, help='Represents the number of Samples to be generated during inference')
